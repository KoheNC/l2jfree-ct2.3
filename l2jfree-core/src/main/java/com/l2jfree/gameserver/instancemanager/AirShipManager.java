...
import com.l2jfree.gameserver.model.actor.instance.L2AirShipControllerInstance;
...
public class AirShipManager
{
	...
	private final void load()
	{
		...
		{
			_log.warn("airship.csv is missing in data folder");
		}
		catch (Exception e)
		{
	...
	private L2AirShipInstance parseLine(String line)
	{
		...
		airShip.getPosition().setXYZ(xspawn, yspawn, zspawn);
