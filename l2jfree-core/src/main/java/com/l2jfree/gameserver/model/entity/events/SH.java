...
public class SH
{
	...
	{
		if (_eventTitle.equals("") || _location.equals("") || _npcId == 0 || _npcX == 0 || _npcY == 0 || _npcZ == 0
				|| _items.size() == 0 || _prizes.size() == 0)
			return false;
		return true;
	}
	...
	public static void showEventHtml(L2PcInstance eventPlayer, String objectId)
	{
		try
		{
			...
			{
				replyMSG.append("<tr></tr>");
				replyMSG.append("<td><font color=\"FFFFFF\">(" + i.getCount() + ") " + i.getItem().getName()
						+ "</font></td>");
			}
			replyMSG.append("<tr></tr>");
			replyMSG.append("<td><center><button value=\"I have the items!\" action=\"bypass -h npc_"
					+ objectId
					+ "_sh_player_has_items\" width=150 height=15 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></center></td>");
			replyMSG.append("<tr></tr>");
			...
			{
				replyMSG.append("<tr></tr>");
				replyMSG.append("<td><font color=\"FFFFFF\">[" + SH.suffixTool(i + 1) + "] " + getWinners().get(i)
						+ "</font></td>");
			}
			...
			{
				replyMSG.append("<tr></tr>");
				replyMSG.append("<td><font color=\"FFFFFF\">[" + SH.suffixTool(i + 1) + "] ("
						+ SH.getPrizes().get(i).getCount() + ") " + SH.getPrizes().get(i).getItem().getName()
						+ "</font></td>");
			}
