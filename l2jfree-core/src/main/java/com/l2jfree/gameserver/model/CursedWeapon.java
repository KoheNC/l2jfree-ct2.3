	...
	*/
	...
	public void reActivate()
	{
		...
		if (_endTime - System.currentTimeMillis() <= 0)
			...
			_removeTask =
					ThreadPoolManager.getInstance().scheduleGeneralAtFixedRate(new RemoveTask(),
	...
	public boolean checkDrop(L2Attackable attackable, L2PcInstance player)
	{
		if (Rnd.get(100000) < _dropRate)
		{
			...
			_removeTask =
					ThreadPoolManager.getInstance().scheduleGeneralAtFixedRate(new RemoveTask(), _durationLost * 12000,
							_durationLost * 12000L);
