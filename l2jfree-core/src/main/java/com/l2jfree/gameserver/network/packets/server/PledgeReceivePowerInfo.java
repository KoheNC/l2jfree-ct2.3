 ...
 * @author  -Wooden-
 */
public class PledgeReceivePowerInfo extends L2ServerPacket
{
	...
	protected void writeImpl()
	{
		...
		writeD(_member.getPledgeRank()); //power grade
		writeS(_member.getName());
		writeD(_member.getClan().getRankPrivs(_member.getPledgeRank())); //privileges
	}
