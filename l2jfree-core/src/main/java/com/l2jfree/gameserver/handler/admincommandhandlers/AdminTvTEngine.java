...
public class AdminTvTEngine implements IAdminCommandHandler
{
	...
	private static final String[] ADMIN_COMMANDS = { "admin_tvt", "admin_tvt_name", "admin_tvt_desc",
			"admin_tvt_join_loc", "admin_tvt_minlvl", "admin_tvt_maxlvl", "admin_tvt_npc", "admin_tvt_npc_pos",
			"admin_tvt_reward", "admin_tvt_reward_amount", "admin_tvt_team_add", "admin_tvt_team_remove",
			"admin_tvt_team_pos", "admin_tvt_team_color", "admin_tvt_join", "admin_tvt_teleport", "admin_tvt_start",
			"admin_tvt_abort", "admin_tvt_finish", "admin_tvt_sit", "admin_tvt_dump", "admin_tvt_save",
			"admin_tvt_load", "admin_tvt_jointime", "admin_tvt_eventtime", "admin_tvt_autoevent",
	...
	public boolean useAdminCommand(String command, L2PcInstance activeChar)
	{
		...
		else if (command.startsWith("admin_tvt_team_color "))
		{
			...
			TvT.setTeamColor(command.substring(params[0].length() + params[1].length() + 2),
	...
	public void showMainPage(L2PcInstance activeChar)
	{
		...
		replyMSG.append("    ... joining location name:&nbsp;<font color=\"00FF00\">" + TvT._joiningLocationName
				+ "</font><br1>");
		replyMSG.append("    ... joining NPC ID:&nbsp;<font color=\"00FF00\">" + TvT._npcId + " on pos " + TvT._npcX
				+ "," + TvT._npcY + "," + TvT._npcZ + "</font><br1>");
		...
		for (String team : TvT._teams)
		{
			...
			replyMSG.append("</td></tr><tr><td>");
			replyMSG.append(TvT._teamsX.get(TvT._teams.indexOf(team)) + ", "
					+ TvT._teamsY.get(TvT._teams.indexOf(team)) + ", " + TvT._teamsZ.get(TvT._teams.indexOf(team)));
			replyMSG.append("</td></tr><tr><td width=\"60\"><button value=\"Remove\" action=\"bypass -h admin_tvt_team_remove "
					+ team + "\" width=50 height=15 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td></tr>");
		}
		...
		if (Config.TVT_EVEN_TEAMS.equals("SHUFFLE"))
		{
			...
			{
				replyMSG.append("<br1>");
				replyMSG.append(TvT._playersShuffle.size()
