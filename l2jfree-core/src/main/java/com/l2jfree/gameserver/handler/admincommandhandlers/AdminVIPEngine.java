...
{
	private static final String[] ADMIN_COMMANDS = { "admin_vip", "admin_vip_setteam", "admin_vip_randomteam",
			"admin_vip_settime", "admin_vip_endnpc", "admin_vip_setdelay", "admin_vip_joininit", "admin_vip_joinnpc",
			"admin_vip_joinlocxyz", "admin_vip_setarea", "admin_vip_vipreward", "admin_vip_viprewardamount",
	...
	public void showMainPage(L2PcInstance activeChar)
	{
		...
		replyMSG.append("    ... End NPC ID:&nbsp;<font color=\"FFFFFF\">" + VIP._endNPC + " ("
				+ VIP.getNPCName(VIP._endNPC, activeChar) + ")</font><br1>");
		replyMSG.append("    ... Join NPC ID:&nbsp;<font color=\"FFFFFF\">" + VIP._joinNPC + " ("
				+ VIP.getNPCName(VIP._joinNPC, activeChar) + ")</font><br>");
		replyMSG.append("    ... Start Location:&nbsp;<font color=\"FFFFFF\">" + VIP._startX + "," + VIP._startY + ","
				+ VIP._startZ + "</font><br1>");
		replyMSG.append("    ... End Location:&nbsp;<font color=\"FFFFFF\">" + VIP._endX + "," + VIP._endY + ","
				+ VIP._endZ + "</font><br1>");
		replyMSG.append("    ... Join Location:&nbsp;<font color=\"FFFFFF\">" + VIP._joinX + "," + VIP._joinY + ","
				+ VIP._joinZ + "</font><br>");
		replyMSG.append("    ... VIP Team Reward:&nbsp;<font color=\"FFFFFF\">"
				+ VIP.getItemName(VIP._vipReward, activeChar) + " (" + VIP._vipRewardAmount + ")</font><br1>");
		replyMSG.append("    ... Not VIP Team Reward:&nbsp;<font color=\"FFFFFF\">"
				+ VIP.getItemName(VIP._notVipReward, activeChar) + " (" + VIP._notVipRewardAmount + ")</font><br1>");
		replyMSG.append("    ... VIP Reward:&nbsp;<font color=\"FFFFFF\">"
				+ VIP.getItemName(VIP._theVipReward, activeChar) + " (" + VIP._theVipRewardAmount + ")</font><br>");
