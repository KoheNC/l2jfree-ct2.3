...
public class PrisonGuards extends L2AttackableAIScript
{
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		{
			L2Npc newGuard =
					addSpawn(npc.getNpcId(), npc.getSpawn().getLocx(), npc.getSpawn().getLocy(), npc.getSpawn()
							.getLocz(), npc.getSpawn().getHeading(), false, 0);
			...
			boolean isSpell)
	{
		...
		{
			String msg =
					(npc.getNpcId() == GUARD1 ? "It's not easy to obtain." : "You're out of your mind comming here...");
