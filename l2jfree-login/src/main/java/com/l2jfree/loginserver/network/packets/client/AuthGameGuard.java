...
import com.l2jfree.loginserver.network.packets.server.GGAuth;
 ...
 */
public class AuthGameGuard extends L2ClientPacket
{
	...
	/**
	 * @see com.l2jfree.loginserver.network.packets.L2ClientPacket#readImpl()
	 */
	@Override
