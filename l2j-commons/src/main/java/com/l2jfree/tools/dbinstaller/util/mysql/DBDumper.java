...
import com.l2jfree.tools.dbinstaller.util.FileWriterStdout;
...
public class DBDumper
{
	...
	public void createDump()
	{
		try (Formatter form = new Formatter())
		{
			...
			try (Statement s = con.createStatement(); ResultSet rset = s.executeQuery("SHOW TABLES"))
			{
				File dump =
						new File("dumps", form.format("%1$s_dump_%2$tY%2$tm%2$td-%2$tH%2$tM%2$tS.sql", _db,
