 ...
 */
package com.l2jfree.tools.dbinstaller.gui;
...
import com.l2jfree.tools.dbinstaller.util.swing.SpringUtilities;
		...
		ActionListener connectListener =
				e -> {
					MySqlConnect connector =
							new MySqlConnect(_dbHost.getText(), _dbPort.getText(), _dbUser.getText(), new String(
									_dbPass.getPassword()), _dbDbse.getText(), false);
					...
					if (connector.getConnection() != null)
					{
						...
						int n =
								JOptionPane.showOptionDialog(null, "Select Installation Type", "Installation Type",
						...
						{
							int conf =
									JOptionPane.showConfirmDialog(null, "Do you really want to destroy your db?",
